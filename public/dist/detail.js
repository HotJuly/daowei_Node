...
__WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default.a.get('/detail-template.html',(data)=>{
    let detail=data;
    __WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default.a.get('http://localhost:3000/item',(data)=>{
        var render=__WEBPACK_IMPORTED_MODULE_1__template___default.a.compile(detail);
        let result=data[0];
        var dt=render(result)
        __WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default()('.service-center').append(dt);
    })
})
