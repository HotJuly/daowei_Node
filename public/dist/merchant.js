...
__WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default.a.get('http://localhost:3000/service',(data)=>{
    console.log(data);
    var li=__WEBPACK_IMPORTED_MODULE_1__template___default()("merchantLi",{list:data});
    __WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default()('#ulactivety').append(li);
})
