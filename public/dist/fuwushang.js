...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3__);
...
__WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default.a.get('/fuwushang-template.html', (data) => {
    detail = data;
    
    __WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default.a.get('http://localhost:3000/comment', (data) => {
        let pageup=__WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default()('.pageup');
        let pagedown=__WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default()('.pagedown');
        let commentDiv=__WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default()('#commentDiv');
        let render = __WEBPACK_IMPORTED_MODULE_1__template___default.a.compile(detail);
        ...
        let nums=__WEBPACK_IMPORTED_MODULE_1__template___default()('num',{numList:new Array(result.length)});
        __WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default()('#showPage').append(nums)
		let num=__WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default()('.num');
		num.eq(page).addClass('acv');
        num.click(function (event) {
          num.removeClass('acv');
          __WEBPACK_IMPORTED_MODULE_0__jquery_1_12_3___default()(this).addClass('acv');
